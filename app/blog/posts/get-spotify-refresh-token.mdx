---
title: 'How to Get a Spotify Refresh Token with Required Scopes'
publishedAt: '2025-02-10'
summary: 'This guide explains how to obtain a new Spotify refresh token that includes the necessary scopes for accessing endpoints such as "currently playing" and "top tracks" using the Spotify API.'
---
...
- **Node.js Environment:** For running the provided Node.js script.  
  _Tip:_ Node.js v18+ includes the `fetch` API by default.
...
_Ensure the URI matches exactly (protocol, domain, port, and trailing slash, if any)._
...
**Create a file named `getRefreshToken.js` _(you can also find it in the repo)_ with the following content:**
