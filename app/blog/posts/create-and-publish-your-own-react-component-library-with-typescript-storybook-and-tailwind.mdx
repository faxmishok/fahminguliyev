...
package name to whatever we want, in our case it is called `@faxmishok/playground`

```json:package.json
"name": "@faxmishok/playground",
...
Boom, you are done! you can now check our NPM account for our new package [@faxmishok/playground](https://www.npmjs.com/package/@faxmishok/playground).
