---
title: 'Install and run python2 and python3 at the same time in one machine'
publishedAt: '2021-04-04'
summary: 'A guide on how to install and run both python2 and python3 at the same time without having conflicts.'
---
...
1. First and foremost, **please** check if you have python3.8, python3 or python2 (python2.7) installed on your machine. Normally you should only have python3.8 installed on ubuntu _by default_.
...
**NOTE:** _The pip version at the beginning may be different from that of what mentioned in the above example. The main thing is that it should print python3.\* (any python version after python3) in parentheses._<br />
...
Now you should download and install **pip2** for _Python 2_ through online script
...
As the last step, you should add the directory that the script _pip2_ is installed in, which will be<br />
